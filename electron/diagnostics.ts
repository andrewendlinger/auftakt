...
export function buildDiagnosticsBundle(input: BundleInput): string {
  ...
  const parts = [
    ...
    `Erstellt: ${at}`,
    '',
    'Diese Datei gehört zur E-Mail mit derselben Kennung. Sie enthält keine privaten oder',
    'vertraulichen Daten — nur Angaben zum Programm und zum Rechner, das Protokoll der letzten',
